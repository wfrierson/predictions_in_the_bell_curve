...
9. It's odd that some of the MCC distributions don't have local optima. E.g., see the plot for Unemployed (Highschool Subset). Inspecting the data and code, I still can't explain it.
