...
2. Review the initial parameters for the batch run procedure on lines 55 - 57 to make sure they're reasonable for your machine.
...
8. The suggested table for interpreting correlation values is only used as a common reference for myself and the reader. Interpretation is always be subjective.
